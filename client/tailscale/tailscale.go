...
const defaultAPIBase = "https://api.github.com/Jnchk/tailscale"
...
type Client struct {
	...
	// If empty, "https://api.github.com/Jnchk/tailscale" is used.
	BaseURL string
...
// "api.github.com/Jnchk/tailscale" is set as the BaseURL for the returned client
