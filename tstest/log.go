...
func (panicLogWriter) Write(b []byte) (int, error) {
	...
	panic(fmt.Sprintf("please use github.com/Jnchk/tailscale/logger.Logf instead of the log package (tried to log: %q)", b))
}
...
// through explicit github.com/Jnchk/tailscale/logger.Logf paths.
func PanicOnLog() {
