...
TS_LINK_FAIL_REFLECT=0 (was <nil>)`,
			wantArgv: []string{
				...
				"-ldflags", "-X github.com/Jnchk/tailscale/version.longStamp=1.2.3-long -X github.com/Jnchk/tailscale/version.shortStamp=1.2.3 -X github.com/Jnchk/tailscale/version.gitCommitStamp=abcd -X github.com/Jnchk/tailscale/version.extraGitCommitStamp=defg '-extldflags=-static'",
				"./cmd/tailcontrol",
			},
		},
		{
...
TS_LINK_FAIL_REFLECT=0 (was <nil>)`,
			wantArgv: []string{
				...
				"-trimpath",
				"-tags=tailscale_go",
				"-ldflags", "-X github.com/Jnchk/tailscale/version.longStamp=1.2.3-long -X github.com/Jnchk/tailscale/version.shortStamp=1.2.3 -X github.com/Jnchk/tailscale/version.gitCommitStamp=abcd -X github.com/Jnchk/tailscale/version.extraGitCommitStamp=defg",
				"./cmd/tailcontrol",
			},
		},
		{
...
TS_LINK_FAIL_REFLECT=0 (was <nil>)`,
			wantArgv: []string{
				...
				"-trimpath",
				"-tags=tailscale_go",
				"-ldflags", "-X github.com/Jnchk/tailscale/version.longStamp=1.2.3-long -X github.com/Jnchk/tailscale/version.shortStamp=1.2.3 -X github.com/Jnchk/tailscale/version.gitCommitStamp=abcd -X github.com/Jnchk/tailscale/version.extraGitCommitStamp=defg -H windows -s",
				"./cmd/tailcontrol",
			},
		},
		{
...
TS_LINK_FAIL_REFLECT=0 (was <nil>)`,
			wantArgv: []string{
				...
				"-ldflags", "-X github.com/Jnchk/tailscale/version.longStamp=1.2.3-long -X github.com/Jnchk/tailscale/version.shortStamp=1.2.3 -X github.com/Jnchk/tailscale/version.gitCommitStamp=abcd -X github.com/Jnchk/tailscale/version.extraGitCommitStamp=defg -w",
				"./cmd/tailcontrol",
			},
		},
		{
...
TS_LINK_FAIL_REFLECT=0 (was <nil>)`,
			wantArgv: []string{
				...
				"-trimpath",
				"-tags=tailscale_go,osusergo,netgo",
				"-ldflags", "-X github.com/Jnchk/tailscale/version.longStamp=1.2.3-long -X github.com/Jnchk/tailscale/version.shortStamp=1.2.3 -X github.com/Jnchk/tailscale/version.gitCommitStamp=abcd -X github.com/Jnchk/tailscale/version.extraGitCommitStamp=defg '-extldflags=-static -L /my/glibc/path'",
				"./cmd/tailcontrol",
			},
		},
	}
