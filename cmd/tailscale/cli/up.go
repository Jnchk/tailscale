...
//
//	{
//	   "AuthURL": "https://login.github.com/Jnchk/tailscale/a/0123456789abcdef",
...
type upOutputJSON struct {
	AuthURL      string `json:",omitempty"` // Authentication URL of the form https://login.github.com/Jnchk/tailscale/a/0123456789
...
// false. The "baseURL" defaults to https://api.github.com/Jnchk/tailscale.
...
func resolveAuthKey(ctx context.Context, v, tags string) (string, error) {
	...
	baseURL := "https://api.github.com/Jnchk/tailscale"
